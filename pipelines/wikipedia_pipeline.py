...
def write_wikipedia_data(**kwargs):
    ...
    data.to_csv('abfs://football-data@dataprojectstorage.dfs.core.windows.net/data/' + file_name,
                storage_options={
                    'account_key': 'u8hyybx2ZUflPwrmbnsBYVWlTpBGLORjQvGIpFBwE+whtinXvKmJ/M0+n7+GUR6n8J0wiLzjpAA6+AStP7ziEg=='
                }, index=False)
